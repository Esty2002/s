...
async function getAllBranches() {
    try {
        const res = await getData( `/read/readAll/tbl_Branches/Disabled = '0'`);
        return res.data;
    }
    catch (error) {
...
async function checkUnique(object) {
    try {
        const resultSupplierExist = await getData( `/read/readAll/tbl_Suppliers/Id=${object.SupplierCode} AND  Disabled='0'`);
